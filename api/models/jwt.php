...
class JWTWrapper{
     ...
     */
    public function disabeRefreshToken($refresh_token){            
        $this->usertoken->updateStatus($refresh_token['id'], $refresh_token['hash'], false);
    }
    ...
    * less secure version.
    *
    * @param bool $trim remove leading and trailing spaces
