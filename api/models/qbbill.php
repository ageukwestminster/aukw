...
class QuickbooksBill{
  ...
  public function delete(): bool{
    ...
    /**
   * Return an array of QBO bill entries identified by $doc_number
   * @param string $doc_number
   * @return IPPIntuitEntity[] Returns an array of bills
   * 
   */
  public function query_by_docnumber(string $doc_number){
    ...
    $journalarray = $dataService->Query("SELECT * FROM Bill WHERE DocNumber LIKE '" .
                                              $doc_number . "%'");
    $error = $dataService->getLastError();
    if ($error) {
        echo "The Status code is: " . $error->getHttpStatusCode() . "\n";
