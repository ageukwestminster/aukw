...
class QBTransferCtl{
  ...
  public static function create_enterprises_interco(string $realmid){  
    ...
    try{
      ...
      QBTransferCtl::createTransfer($realmid, $data->txnDate, $fromAccount, 
            $toAccount, $data->amount, isset($data->privateNote)?$data->privateNote:'');
   ...
   * @throws IdsException 
   */
  private static function createTransfer(string $realmid, string $txnDate,
      int $fromAccount, int $toAccount, float $amount, string $privateNote = '') : void {
